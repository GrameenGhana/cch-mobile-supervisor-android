...
public class MetaDataUtils {
	...
	public MetaDataUtils(Context ctx){
		...
		networkProvider = "Vodafone";//manager.getNetworkOperatorName();
		deviceId = "davids"; // manager.getDeviceId();
		simSerial = "sssss";// manager.getSimSerialNumber();
	}
	...
	private float getBatteryLevel() throws NullPointerException {
